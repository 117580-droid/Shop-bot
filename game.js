        ...
        return await interaction.editReply({
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(`**StrawhatMessi** was hiding at **${revealedPoi.name}**`)
